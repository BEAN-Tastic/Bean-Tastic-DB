...
INSERT INTO [dbo].[EnemyAction] ([enemyId], [enemyActionTypeId], [name], [description])
VALUES 
    ((SELECT TOP 1 [enemyId] FROM [dbo].[Enemy] WHERE [name] = 'Sorcerer Soup'), 
     (SELECT TOP 1 [enemyActionTypeId] FROM [dbo].[EnemyActionType] WHERE [description] = 'Strong'), 
     'Fiery Ladle Strike', 
    ...
    ((SELECT TOP 1 [enemyId] FROM [dbo].[Enemy] WHERE [name] = 'Cursed Carrot'), 
     (SELECT TOP 1 [enemyActionTypeId] FROM [dbo].[EnemyActionType] WHERE [description] = 'Weak'), 
     'Toxic Root Slam', 
    ...
    ((SELECT TOP 1 [enemyId] FROM [dbo].[Enemy] WHERE [name] = 'Ghoulish Grapes'), 
     (SELECT TOP 1 [enemyActionTypeId] FROM [dbo].[EnemyActionType] WHERE [description] = 'Normal'), 
     'Bitter Bite', 
    ...
    ((SELECT TOP 1 [enemyId] FROM [dbo].[Enemy] WHERE [name] = 'Vengeful Vegetable'), 
     (SELECT TOP 1 [enemyActionTypeId] FROM [dbo].[EnemyActionType] WHERE [description] = 'Normal'), 
     'Volatile Vine Whiplash', 
     'The Vengeful Vegetable lashes out with volatile vines, causing moderate damage to your attack power.'),
