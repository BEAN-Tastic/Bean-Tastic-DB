INSERT INTO Item (itemQualityId, name, description)
VALUES
    ((SELECT itemQualityId FROM ItemQuality WHERE name = 'Common'),
     'Mystic Carrot',
    ...
    ((SELECT itemQualityId FROM ItemQuality WHERE name = 'Uncommon'),
     'Sorcerer''s Walnut',
    ...
    ((SELECT itemQualityId FROM ItemQuality WHERE name = 'Epic'),
     'Witch''s Watermelon',
     'A watermelon infused with witchcraft that boosts all stats'),

    ((SELECT itemQualityId FROM ItemQuality WHERE name = 'Rare'),
     'Wizard''s Strawberry',
